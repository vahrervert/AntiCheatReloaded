 ...
 *   <li>Check
 *     <ul>
 *       <li>Contains all valid checks as listed in {@link com.rammelkast.anticheatreloaded.check.CheckType}</li>
 ...
 * The only current Rule implementation is the {@link com.rammelkast.anticheatreloaded.util.rule.ConditionalRule}
 */
public class Rule {
     ...
     *
     * @return a {@link com.rammelkast.anticheatreloaded.util.rule.Rule.Type}
     */
    public Type getType() {
        return type;
    }
